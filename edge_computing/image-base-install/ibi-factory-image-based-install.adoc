...
Use the `openshift-install` installation program to create a live installation ISO for preinstalling {sno} on bare-metal hosts. For more information about downloading the installation program, see "Installation process" in the _Additional resources_ section.
