...
include::modules/ztp-deploying-a-site.adoc[leveloffset=+21]
...
* For information on removing a cluster, see link:https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.4/html/clusters/managing-your-clusters#remove-managed-cluster[Removing a cluster from management].
...
.Additional resources
* For information about creating `ClusterGroupUpgrade` CRs, see xref:../scalability_and_performance/ztp-deploying-disconnected.adoc#talo-create-cgu-cr_ztp-deploying-disconnected[Creating the ClusterGroupUpgrade CR].
