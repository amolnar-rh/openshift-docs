...
.Additional resources
* For information on using TALO to construct your own `ClusterGroupUpgrade` CR, see xref:../scalability_and_performance/cnf-talo-for-cluster-upgrades.html#talo-about-cgu-crs_cnf-topology-aware-lifecycle-operator[About the ClusterGroupUpgrade CR].
...
.Additional resources
* For information about Topology Aware Lifecycle Operator (TALO), see xref:../scalability_and_performance/cnf-talo-for-cluster-upgrades.html[Topology Aware Lifecycle Operator for cluster updates].
...
.Additional resources
* For information on creating `ClusterGroupUpgrade` CRs, see xref:../scalability_and_performance/ztp-deploying-disconnected.html#talo-create-cgu-cr_cnf-topology-aware-lifecycle-operator[Creating the ClusterGroupUpgrade CR].
