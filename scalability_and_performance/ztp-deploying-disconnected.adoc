...
* For more information about mirroring images to the disconnected registry, see xref:../installing/disconnected_install/installing-mirroring-installation-images.html#installing-mirroring-installation-images[Mirroring images for a disconnected installation].
...
* For information about using TALO to construct your own `ClusterGroupUpgrade` CR, see xref:../scalability_and_performance/cnf-talo-for-cluster-upgrades.adoc#talo-about-cgu-crs_cnf-topology-aware-lifecycle-operator[About the ClusterGroupUpgrade CR].
...
.Additional resources
* For information about Topology Aware Lifecycle Operator (TALO), see xref:../scalability_and_performance/cnf-talo-for-cluster-upgrades.adoc#cnf-about-topology-aware-lifecycle-operator-config_cnf-topology-aware-lifecycle-operator[About the Topology Aware Lifecycle Operator configuration].
...
* For more information about how to prepare the disconnected environment, see xref:../scalability_and_performance/ztp-deploying-disconnected.adoc#ztp-acm-preparing-to-install-disconnected-acm_ztp-deploying-disconnected[Preparing the disconnected environment].

* For more information about mirroring the desired image repository, see xref:../scalability_and_performance/ztp-deploying-disconnected.adoc#ztp-acm-preparing-to-install-disconnected-acm_ztp-deploying-disconnected[Preparing the disconnected environment].

* For more information about update channels and releases, see xref:../updating/understanding-upgrade-channels-release.html[Understanding upgrade channels and releases].
...
* For more information on mirorring the images in a disconnected environment, xref:../scalability_and_performance/ztp-deploying-disconnected.adoc#ztp-acm-preparing-to-install-disconnected-acm_ztp-deploying-disconnected[Preparing the disconnected environment]
