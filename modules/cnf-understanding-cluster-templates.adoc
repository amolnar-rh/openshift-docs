...
Cluster templates are the set of installation artifacts that are generated from the `ClusterInstance` CR.
The {sco} defines cluster templates by using the Golang text template package, and the Operator instantiates these cluster templates by using the data from the `ClusterInstance` CR.
