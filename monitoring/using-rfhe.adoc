...
The {redfish-operator} is not available in the `redhat-operators` Operators source for {product-title} version {product-version}. To use the Operator, you must install the upstream version.
