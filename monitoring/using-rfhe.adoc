...
You can use the {product-title} console to install the Redfish hardware event service by deploying the Operator and subscribing to the service. The Operator manages the lifecycle of the event service.
